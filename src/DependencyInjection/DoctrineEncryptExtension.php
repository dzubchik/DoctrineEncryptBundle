...
use Paymaxi\DoctrineEncryptBundle\Encryptors\AES192Encryptor;
...
class DoctrineEncryptExtension extends Extension
{
    ...
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        //Set parameters
        $container->setParameter('paymaxi_doctrine_encrypt.encryptor_class_name', $config['encryptor_class']);
        $container->setParameter('paymaxi_doctrine_encrypt.secret_key', $config['secret_key']);
    ...
    {
        return 'paymaxi_doctrine_encrypt';
    }
}
