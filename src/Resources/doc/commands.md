...
* Optional parameter [encryptor]
    * An encryptor provided by the bundle (AES-256 or AES-128) or your own [encryption class](https://github.com/paymaxi/DoctrineEncryptBundle/blob/master/Resources/doc/custom_encryptor.md).
...
```
$ php app/console doctrine:encrypt:database \Paymaxi\DoctrineEncryptBundle\Encryptors\AES256Encryptor
```
...
```
$ php app/console doctrine:decrypt:database \Paymaxi\DoctrineEncryptBundle\Encryptors\AES256Encryptor
```
